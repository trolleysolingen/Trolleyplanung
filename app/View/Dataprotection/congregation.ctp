<div class="dataprotection form">
	...
	<div class="col-md-6 col-xs-12">
		...
		<div class="panel panel-primary" style="padding:20px;">
			<p>Für alle Verkündiger ohne Login, bitte folgendes Formular herunterladen, unterschreiben lassen und bis zum 30.06.2018 an folgende Adresse schicken:</p>
			<p><b>Felix Bornmann</b><br/>
			Kasernenstr. 38<br/>
			42651 Solingen</p>
			<br/>
			<p>Nach Eingang werden die Verkündiger, die unterschrieben haben dann markiert mit "Datenschutzvereinbarung akzeptiert". Alle anderen werden nach dem 30.06.2018 gelöscht.</p>
