<div class="publishers form">
	...
	<fieldset>
		<legend><?php echo __('Verkündiger anlegen'); ?></legend>
		<?php
		...
		<div class="form-group">
			<div class="col-sm-1 col-md-2"></div>
			<label for="email" class="col-sm-2 control-label">Passwort:</label>
			<div class="col-sm-8 col-md-6">
				<?php
				echo $this->Form->input('password', array('label'=>false, 'class' => 'form-control', 'placeholder' => 'Passwort', 'id' => 'password'));
				?>
			</div>
			<div class="col-sm-1 col-md-2"></div>
		</div>
