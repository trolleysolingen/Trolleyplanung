<div class="congregations index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $congregation['Congregation']['id']), array(), __('Are you sure you want to delete # %s?', $congregation['Congregation']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
