			...
			<thead>
				<tr>
					...
					?>
							...
							<th width="10%"><?php echo $this->Paginator->sort('phone', 'Telefon'); ?></th>
							<th width="10%"><?php echo $this->Paginator->sort('description', 'Beschreibung'); ?></th>
							<th width="5%"><?php echo $this->Paginator->sort('dataprotection', 'Datenschutz'); ?></th>
				...
				<?php foreach ($publishers as $publisherItem): ?>
					<tr>
						...
						<?php
							...
							if ($publisher['Role']['name'] == 'admin' || $publisher['Role']['name'] == 'congregation admin') {
						?>
							<td><?php echo h($publisherItem['Publisher']['description']); ?>&nbsp;</td>
